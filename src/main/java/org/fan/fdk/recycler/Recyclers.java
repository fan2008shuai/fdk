...
public abstract class Recyclers<T> {
    ...
    static {
        int maxCapacityPerThread = NumberUtils.toInt(System.getProperty("fdk.recyclers.maxCapacityPerThread"), DEFAULT_INITIAL_MAX_CAPACITY_PER_THREAD);
